...
- **The surface moves.** `adapty asa` lives on an unmerged PR that gained a commit mid-authoring and silently invalidated verified facts. Pin the commit you verified against in your notes, and re-check numbers rather than trusting a previous pass.
